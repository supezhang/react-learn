        ...
        <ul>
          {
            msgArr.map(msg=>{
              ...
              // state 传参
              return  <li key={msg.id}><MyNavlink activeClassName="on" replace={true} to={{pathname:'/home/message/detail',state:{id:msg.id,title:msg.title}}}  id={msg.id} children={msg.title}></MyNavlink></li>     
            })
          }             
        </ul>
